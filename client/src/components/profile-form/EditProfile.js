...
const EditProfile = ({
  ...
  const [dispalySocialInputs, setDisplaySocialInputs] = useState(false);
  ...
  return (
    <Fragment>
      ...
      <form className='form' onSubmit={e => onSubmit(e)}>
        ...
        <div className='my-2'>
          <button
            onClick={() => setDisplaySocialInputs(!dispalySocialInputs)}
            type='button'
...
export default connect(
  mapStateToProps,
  { createUpdateProfile, getCurrentProfile }
